Hey, here is the first version of the API call to use davinci-003 engine/model. You can look at it but I would rather advise you to use the second Version, because it's way simpler and straightforward.
