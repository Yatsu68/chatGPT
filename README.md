...
In order to use this code:
  ...
  - You need to have the required packages installed from npm or yarn in your project (express.js and body-parser should be enough for the V1 and openai for the V2)
